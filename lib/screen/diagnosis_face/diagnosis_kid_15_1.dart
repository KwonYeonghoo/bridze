// 아이의 정서 평가 네 번째 질문이 나옵니다.
// 질문의 음성을 듣고 질문 하단에 해당하는 점수 버튼을 누릅니다.
// 오른쪽 하단에 화살표를 누르면 다음 페이지로 넘어갑니다.

import 'package:bridze/provider/face_evaluation.dart';
import 'package:bridze/screen/diagnosis_face/diagnosis_kid_15_2.dart';
import 'package:bridze/widgets/audio_kid_4.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class DiagnosisKid151Page extends StatefulWidget {
  const DiagnosisKid151Page({Key? key, required String avrScore})
      : super(key: key);

  @override
  DiagnosisKid151PageState createState() => DiagnosisKid151PageState();
}

class DiagnosisKid151PageState extends State<DiagnosisKid151Page> {
  AudioKid4 myAudioPlayer = AudioKid4();
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const DiagnosisKid152Page(),
                          ),
                        );
                      },
                      child: Image.asset(
